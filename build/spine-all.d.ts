...
declare module spine {
    export class SkeletonBinary {
        ...
        readSkeletonBone(input: BinaryInput, skeletonData: SkeletonData): void;
        readSkeletonDevisionCyspSkeleton(binary: Uint8Array, checkBody?: boolean): SkeletonData;
...
declare module spine.webgl {
    ...
    class Matrix4 {
        ...
        scale(x: number, y: number, z?: number, w?: number): Matrix4;
